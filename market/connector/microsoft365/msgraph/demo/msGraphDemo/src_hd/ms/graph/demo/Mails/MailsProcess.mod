[Ivy]
1783B5D5B8717FCA 9.2.0 #module
>Proto >Proto Collection #zClass
Es0 MailsProcess Big #zClass
Es0 RD #cInfo
Es0 #process
...
>Proto Es0 Es0 MailsProcess #zField
Es0 f0 guid 178353D928F6A393 #txt
Es0 f0 method start(java.util.List<com.microsoft.graph.MicrosoftGraphMessage>) #txt
Es0 f0 inParameterDecl '<java.util.List<com.microsoft.graph.MicrosoftGraphMessage> mails> param;' #txt
Es0 f0 inParameterMapAction 'out.mails=param.mails;
' #txt
...
>Proto Es0 .type ms.graph.demo.Mails.MailsData #txt
